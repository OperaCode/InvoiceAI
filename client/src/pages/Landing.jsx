...
const features = [
  {
    ...
    description:
      "Create professional invoices instantly with smart automation.",
  },
  {
    title: "Customizable Templates",
    description:
      "Choose from sleek, professional designs tailored to your brand.",
  },
  {
    title: "Client Editing Interface",
    description: "Easily edit and manage client details in real-time.",
  },
  {
    title: "Instant Preview & Send",
    description: "Preview your invoice and send it directly to clients.",
  },
  {
    title: "No Signup Needed",
    description: "Get started immediately without any account setup.",
  },
  {
    title: "Secure & Fast Delivery",
    description: "Ensure safe and rapid delivery of invoices to your clients.",
  },
];
...
const testimonials = [
  {
    ...
    quote:
      "InvoiceAI saved me hours every week. Invoices are ready in seconds, and my clients love the clean format.",
  ...
  },
  {
    ...
    quote:
      "We automated all our contractor invoices using InvoiceAI. It's fast, easy, and beautifully simple.",
...
const Landing = () => {
  ...
  const fullHeadline = "Invoice Smarter with AI";
    ...
    <div className="font-inter text-gray-900 bg-white min-h-screen">
        ...
        <nav className="fixed top-0 left-0 right-0 bg-white/90 backdrop-blur-md shadow z-50">
          <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <div className="hidden md:flex space-x-8 items-center">
              <a
                href="#home"
                className="text-gray-700 hover:text-cyan-500 transition font-bold cursor-pointer"
              >
                Home
              </a>
              <a
              ...
              <a
                href="/home"
                className="bg-gradient-to-r from-purple-500 to-indigo-600 text-white px-4 py-2 rounded-lg hover:opacity-90 transition cursor-pointer"
              >
                Get Started
              </a>
            </div>
          ...
          {isMenuOpen && (
            <div className="md:hidden bg-white shadow-md">
              <a
                href="#home"
                className="block px-6 py-3 text-gray-700 hover:bg-cyan-50"
              >
                Home
              </a>
              <a
              ...
              <a
                href="#start"
                className="block px-6 py-3 text-white bg-gradient-to-r from-purple-500 to-indigo-600"
              >
                Get Started
              </a>
            </div>
      ...
      >
        ...
        <p className="text-lg md:text-xl max-w-2xl mb-8 leading-relaxed text-white/90">
          InvoiceAI empowers freelancers & startups with AI-generated,
          ready-to-send invoices — no signup, no hassle.
        </p>
        <a
          href="/home"
      ...
      <section
        id="start"
        className="py-24 px-6 bg-gradient-to-r from-purple-700 via-indigo-700 to-cyan-600 text-white text-center"
      >
        <h2 className="text-4xl font-bold mb-6">
          Smarter Invoicing Starts Now
        </h2>
      ...
      <footer className="bg-gray-100 py-8 text-center text-sm text-gray-600">
        <p>
          &copy; {new Date().getFullYear()} InvoiceAI — AI Invoicing,
          Reimagined.
        </p>
